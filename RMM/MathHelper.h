...
public:
	...
	static bool computeICPAlignment(const std::vector<double>& source, const std::vector<double>& target, const std::vector<double>& targetNormals, const KDTree3& targetKDTree
											, const double maxIPPointDist, double& s, std::vector<double>& R, std::vector<double>& t, bool bScaling = true);
	...
	static bool computeCovarianceMatrix(const std::vector<double>& centeredData, const std::vector<size_t>& semCorr, const std::vector<size_t>& modeDim, const size_t mode, std::vector<double>& covarianceMatrix, size_t& matrixDim);

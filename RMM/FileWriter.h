...
public:
	...
	static bool writeFileCollection(const std::string& sstrFileName, const std::vector<std::string>& fileNames, const size_t numIdentities, const size_t numExpressions);

	static bool writeFileCollection(const std::string& sstrFileName, const std::vector<std::string>& fileNames, const std::vector<size_t>& permutation, const size_t numIdentities, const size_t numExpressions);

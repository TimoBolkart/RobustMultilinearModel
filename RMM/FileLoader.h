...
public:
	...
	bool readCorruptFileCollection(const std::string& sstrFileName, std::vector<std::string>& dataFileNames, std::vector<std::string>& corruptDataFileNames, std::vector<std::string>& corruptDataLmksFileNames);

	bool loadIncompleteFileCollection(const std::string& sstrFileName, std::vector<double>& data, DataContainer& mesh, std::vector<std::string>& fileNames, std::vector<bool>& missingShapes, size_t& numExpressions, size_t& numIdentities);

	bool loadCorruptFileCollection(const std::string& sstrFileName, std::vector<std::string>& dataFileNames, std::vector<DataContainer*>& corruptData, std::vector<std::vector<std::pair<double,bool>>>& corruptDataLmks);
